; fp_core_fused_maps_i16.asm
;
; Hand-optimized x64 AVX2 SIMD implementations for i16 fused maps
...
;
; Functions:
;   - fp_map_axpy_i16:    out = c*x + y (SIMD multiply + add!)
;   - fp_map_scale_i16:   out = c*x (SIMD multiply!)
...
; ============================================================================
; fp_map_axpy_i16: AXPY operation (out = c*x + y)
; ============================================================================
; Signature: void fp_map_axpy_i16(const int16_t* x, const int16_t* y, int16_t* out, size_t n, int16_t c);
;
; HUGE advantage over i64: vpmullw gives us true SIMD multiply!
...
; ============================================================================
; fp_map_scale_i16: Scale operation (out = c*x)
; ============================================================================
; Signature: void fp_map_scale_i16(const int16_t* x, int16_t* out, size_t n, int16_t c);
;
...
; ============================================================================
; fp_map_offset_i16: Offset operation (out = x + c)
; ============================================================================
; Signature: void fp_map_offset_i16(const int16_t* x, int16_t* out, size_t n, int16_t c);
...
; ============================================================================
; fp_zip_add_i16: Zip add operation (out = x + y)
; ============================================================================
; Signature: void fp_zip_add_i16(const int16_t* x, const int16_t* y, int16_t* out, size_t n);
