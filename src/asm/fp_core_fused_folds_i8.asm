; fp_core_fused_folds_i8.asm
;
; Hand-optimized x64 AVX2 SIMD implementations for i8 fused folds
...
;
; Functions:
;   - fp_fold_sumsq_i8:  Sum of squares (scalar - no SIMD multiply)
;   - fp_fold_dotp_i8:   Dot product (scalar - no SIMD multiply)
;   - fp_fold_sad_i8:    Sum of absolute differences (SIMD - 32-wide!)
...
; ============================================================================
; fp_fold_sumsq_i8: Sum of squares
; ============================================================================
; Signature: int8_t fp_fold_sumsq_i8(const int8_t* input, size_t n);
;
; LIMITATION: No vpmullb, must use scalar

global fp_fold_sumsq_i8
fp_fold_sumsq_i8:
    push rbp
    mov rbp, rsp
...
; ============================================================================
; fp_fold_dotp_i8: Dot product
; ============================================================================
; Signature: int8_t fp_fold_dotp_i8(const int8_t* a, const int8_t* b, size_t n);
;
; LIMITATION: No vpmullb, must use scalar

global fp_fold_dotp_i8
fp_fold_dotp_i8:
    push rbp
    mov rbp, rsp
...
; ============================================================================
; fp_fold_sad_i8: Sum of absolute differences
; ============================================================================
; Signature: int8_t fp_fold_sad_i8(const int8_t* a, const int8_t* b, size_t n);
;
; Strategy: Use bitwise absolute value trick
; abs(x) = (x XOR sign_mask) - sign_mask where sign_mask = x >> 7

global fp_fold_sad_i8
fp_fold_sad_i8:
    push rbp
    mov rbp, rsp
    sub rsp, 32
...
.horizontal_sum:
    ...
    ; ymm0 has 32 signed bytes (absolute values are positive, fit in i8)
